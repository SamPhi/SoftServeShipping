...
class actuator():
    ...
    def __init__(self):
        ...
        self.zeroPos = 0
        self.last_x_pos = 0
        self.massGantry = 0.5 #Kg
        self.massContainer = 0.1 #Kg
        self.lengthCable = 0.25 #m
        self.g = 9.81 #m/s^2
        self.dt = 0.001
        self.lastTheta = 0
    ...
    def autoMove(self, x_des):
        ...
        g = self.g
        l = self.lengthCable
        mg = self.massGantry #Kg
        mc = self.massContainer #Kg
        t = self.dt
        th_past = self.lastTheta
        dth = (th_past - th)/self.dt
        x = self.x_pos
